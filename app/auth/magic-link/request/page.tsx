...
export default function MagicLinkRequestPage() {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-16">
      <h1 className="text-xl font-semibold text-neutral-900 mb-2">Sign in with a link</h1>
      <p className="text-sm text-neutral-500 mb-6">We'll email you a one-time link — no password needed.</p>
